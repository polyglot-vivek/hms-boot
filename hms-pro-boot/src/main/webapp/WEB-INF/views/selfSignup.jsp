                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li ><a href="home">Home</a></li>
                         <li class="active"><i class="icon-home icon-black"></i><a href="#">SignUp</a></li>
    	...
    	<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<core:if test="${not empty patRegStatus}">
 <b><font color="green"><core:out value="${patRegStatus}"></core:out></font></b>
</core:if>
						<div class="row">
							<div class="col-xs-6">							
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form:form id="registration-form" action="./selfSignup"  commandName="outPatientBean" method="POST">
									...
									<div class="form-group">
										<form:input path="fname" type="text"  id="firstName" tabindex="1" class="form-control" placeholder="FirstName" value=""></form:input>
									</div>
									<div class="form-group">
										<form:input path="lname" type="text"  id="lastName" tabindex="1" class="form-control" placeholder="LastName" value=""></form:input>
									</div>
									<div class="form-group">
									...
									<%-- <div class="form-group">
										<form:input path="confirmPassword" type="password"  id="confirmPasswoord" tabindex="2" class="form-control" placeholder="confirmPasswoord" value=""></form:input>
									</div> --%>
									<div class="form-group">
										<form:input path="email" type="text"  id="email" tabindex="1" class="form-control" placeholder="Email" value=""></form:input>
									</div>
									<div class="form-group">
										<form:input path="mobile" type="text"  id="phoneNumber" tabindex="1" class="form-control" placeholder="PhoneNumber" value=""></form:input>
									</div>
